...
print(([&](oml_root* x,oml_root* y){x=new_number(11);y=new_number(22);return ((new_number(number_value(x)+number_value(y))));})(0,0));
print(([&](oml_root* x,oml_root* y){x=new_number(11);y=new_number(22);return ((new_number(number_value(x)+number_value(y))));})(0,0));
std::function<oml_root*(oml_root*)> fact=[&](oml_root* x)->oml_root*{return (([&](oml_root* n,oml_root* rlt){n=new_number(2);rlt=new_number(1);return ((([&]()->void {while(!(number_value(x)<number_value(n))){(rlt=(new_number(number_value(rlt)*number_value(n))),n=(new_number(1+number_value(n))));}})(),0),rlt);})(0,0));};
print(fact(new_number(4)));
std::function<oml_root*(oml_root*)> fact2=[&](oml_root* x)->oml_root*{return (([&](oml_root* n,oml_root* rlt){n=new_number(2);rlt=new_number(1);return ((([&]()->void {while(!(number_value(x)<number_value(n))){oml_root* __do__[2];(rlt=(new_number(number_value(rlt)*number_value(n))),__do__[0]=(new_number(1+number_value(n))),n=__do__[0]);}})(),0),rlt);})(0,0));};
print(fact2(new_number(4)));
std::function<oml_root*()> dummy1=[&]()->oml_root*{return (([&](oml_root* a){a=new_number(22);return (([&](oml_root* b){b=new_number(33);return (print((new_number(number_value(a)+number_value(b)))));})(0));})(0));};
dummy1();
std::function<oml_root*()> dummy2=[&]()->oml_root*{return (([&](std::function<oml_root*(oml_root*,oml_root*)> my_add2){my_add2=[&](oml_root* a,oml_root* b)->oml_root*{return ((new_number(number_value(a)+number_value(b))));};return (print(my_add2(new_number(33),new_number(44))));})(0));};
dummy2();
...
(([&](oml_root* x){x=new_number(20);return (print(new_list(new (GC) oml_list_data {new_number(1),x,new_number(3)},new (GC) oml_dict_data {})));})(0));
...
(([&](oml_root* x){x=new_number(123);return (([&](oml_root* __case__){__case__=x;return ((bool_value(bool_value(equal(__case__,new_number(-1))))?(console_log(new_string("(case1)")),new_number(1)):((console_log(new_string("(case2)")),new_number(2)))));})(0));})(0));
(([&](oml_root* x){x=new_list(new (GC) oml_list_data {new_number(11),new_number(22),new_number(33)},new (GC) oml_dict_data {{":key1",new_bool(true)},{":key2",new_string("abc")}});return (([&](oml_root* __case__){__case__=x;return ((bool_value(bool_value(equal(__case__,new_list(new (GC) oml_list_data {new_number(11),new_number(22),new_number(33)},new (GC) oml_dict_data {{":key1",new_bool(true)},{":key2",new_string("xyz")}}))))?(console_log(new_string("(case1)")),new_number(1)):((bool_value(bool_value(equal(__case__,new_list(new (GC) oml_list_data {new_number(11),new_number(22),new_number(33)},new (GC) oml_dict_data {{":key1",new_bool(true)},{":key2",new_string("abc")}}))))?(console_log(new_string("(case2)")),new_number(2)):((console_log(new_string("(case3)")),new_number(3)))))));})(0));})(0));
