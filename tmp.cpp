...
int main()
{
    ...
    console_log((new_number(5*to_number((new_number(2+3)))*10)));
    ...
    {
        (rlt=(new_number(to_number(rlt)*to_number(n))),n=(new_number(1+to_number(n))));
        }})(),0),rlt);
    })(0,0));
                                                                                    };
    ...
    {
        oml_root* __do__[2];
            (rlt=(new_number(to_number(rlt)*to_number(n))),__do__[0]=(new_number(1+to_number(n))),n=__do__[0]);
        }})(),0),rlt);
