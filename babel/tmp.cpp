...
int main()
{
    ...
    try
    {
        ...
        var list1=new_list({new_number(11),new_number(22),new_number(33)});
        var dict=new_dict({{"a",new_number(11)},{"b",new_number(22)},{"c",new_number(33)}});
        (*print)({((*(list1))+(*(dict)))});
        var list2=new_list({new_number(11),new_number(22),new_number(33),new_list({new_number(44),new_number(55)})});
        (*print)({((*(list2))+(*(dict)))});
        ...
        {
            {
                var __switch1__=((*(s))+(*(new_string("C"))));
