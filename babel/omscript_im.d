...
static this() {
  ...
  mixin(bindCode("om_register_ptr_vector_empty", "D_om_register_ptr_vector_empty"));
  mixin(bindCode("om_register_ptr_vector_clear", "D_om_register_ptr_vector_clear"));
  mixin(bindCode("om_register_ptr_vector_push_back", "D_om_register_ptr_vector_push_back"));
  mixin(bindCode("om_register_ptr_vector_pop_back", "D_om_register_ptr_vector_pop_back"));
  mixin(bindCode("om_register_ptr_vector_size", "D_om_register_ptr_vector_size"));
  mixin(bindCode("om_register_ptr_vector_capacity", "D_om_register_ptr_vector_capacity"));
  mixin(bindCode("om_register_ptr_vector_reserve", "D_om_register_ptr_vector_reserve"));
  mixin(bindCode("new_om_register_ptr_vector__SWIG_0", "D_new_om_register_ptr_vector__SWIG_0"));
  mixin(bindCode("new_om_register_ptr_vector__SWIG_1", "D_new_om_register_ptr_vector__SWIG_1"));
  mixin(bindCode("new_om_register_ptr_vector__SWIG_2", "D_new_om_register_ptr_vector__SWIG_2"));
  mixin(bindCode("om_register_ptr_vector_remove__SWIG_0", "D_om_register_ptr_vector_remove__SWIG_0"));
  mixin(bindCode("om_register_ptr_vector_remove__SWIG_1", "D_om_register_ptr_vector_remove__SWIG_1"));
  mixin(bindCode("om_register_ptr_vector_removeBack", "D_om_register_ptr_vector_removeBack"));
  mixin(bindCode("om_register_ptr_vector_linearRemove", "D_om_register_ptr_vector_linearRemove"));
  mixin(bindCode("om_register_ptr_vector_insertAt", "D_om_register_ptr_vector_insertAt"));
  mixin(bindCode("om_register_ptr_vector_getElement", "D_om_register_ptr_vector_getElement"));
  mixin(bindCode("om_register_ptr_vector_setElement", "D_om_register_ptr_vector_setElement"));
  mixin(bindCode("delete_om_register_ptr_vector", "D_delete_om_register_ptr_vector"));
}
...
SwigExternC!(uint function(void* jarg1)) om_register_ptr_vector_empty;
SwigExternC!(void function(void* jarg1)) om_register_ptr_vector_clear;
SwigExternC!(void function(void* jarg1, void* jarg2)) om_register_ptr_vector_push_back;
SwigExternC!(void function(void* jarg1)) om_register_ptr_vector_pop_back;
SwigExternC!(size_t function(void* jarg1)) om_register_ptr_vector_size;
SwigExternC!(size_t function(void* jarg1)) om_register_ptr_vector_capacity;
SwigExternC!(void function(void* jarg1, size_t jarg2)) om_register_ptr_vector_reserve;
SwigExternC!(void* function()) new_om_register_ptr_vector__SWIG_0;
SwigExternC!(void* function(void* jarg1)) new_om_register_ptr_vector__SWIG_1;
SwigExternC!(void* function(size_t jarg1)) new_om_register_ptr_vector__SWIG_2;
SwigExternC!(void* function(void* jarg1)) om_register_ptr_vector_remove__SWIG_0;
SwigExternC!(void* function(void* jarg1, size_t jarg2)) om_register_ptr_vector_remove__SWIG_1;
SwigExternC!(void function(void* jarg1, size_t jarg2)) om_register_ptr_vector_removeBack;
SwigExternC!(void function(void* jarg1, size_t jarg2, size_t jarg3)) om_register_ptr_vector_linearRemove;
SwigExternC!(void function(void* jarg1, size_t jarg2, void* jarg3)) om_register_ptr_vector_insertAt;
SwigExternC!(void* function(void* jarg1, size_t jarg2)) om_register_ptr_vector_getElement;
SwigExternC!(void function(void* jarg1, size_t jarg2, void* jarg3)) om_register_ptr_vector_setElement;
SwigExternC!(void function(void* jarg1)) delete_om_register_ptr_vector;
