...
static this() {
  ...
  mixin(bindCode("RegisterPtrVector_empty", "D_RegisterPtrVector_empty"));
  mixin(bindCode("RegisterPtrVector_clear", "D_RegisterPtrVector_clear"));
  mixin(bindCode("RegisterPtrVector_push_back", "D_RegisterPtrVector_push_back"));
  mixin(bindCode("RegisterPtrVector_pop_back", "D_RegisterPtrVector_pop_back"));
  mixin(bindCode("RegisterPtrVector_size", "D_RegisterPtrVector_size"));
  mixin(bindCode("RegisterPtrVector_capacity", "D_RegisterPtrVector_capacity"));
  mixin(bindCode("RegisterPtrVector_reserve", "D_RegisterPtrVector_reserve"));
  mixin(bindCode("new_RegisterPtrVector__SWIG_0", "D_new_RegisterPtrVector__SWIG_0"));
  mixin(bindCode("new_RegisterPtrVector__SWIG_1", "D_new_RegisterPtrVector__SWIG_1"));
  mixin(bindCode("new_RegisterPtrVector__SWIG_2", "D_new_RegisterPtrVector__SWIG_2"));
  mixin(bindCode("RegisterPtrVector_remove__SWIG_0", "D_RegisterPtrVector_remove__SWIG_0"));
  mixin(bindCode("RegisterPtrVector_remove__SWIG_1", "D_RegisterPtrVector_remove__SWIG_1"));
  mixin(bindCode("RegisterPtrVector_removeBack", "D_RegisterPtrVector_removeBack"));
  mixin(bindCode("RegisterPtrVector_linearRemove", "D_RegisterPtrVector_linearRemove"));
  mixin(bindCode("RegisterPtrVector_insertAt", "D_RegisterPtrVector_insertAt"));
  mixin(bindCode("RegisterPtrVector_getElement", "D_RegisterPtrVector_getElement"));
  mixin(bindCode("RegisterPtrVector_setElement", "D_RegisterPtrVector_setElement"));
  mixin(bindCode("delete_RegisterPtrVector", "D_delete_RegisterPtrVector"));
}
...
SwigExternC!(uint function(void* jarg1)) RegisterPtrVector_empty;
SwigExternC!(void function(void* jarg1)) RegisterPtrVector_clear;
SwigExternC!(void function(void* jarg1, void* jarg2)) RegisterPtrVector_push_back;
SwigExternC!(void function(void* jarg1)) RegisterPtrVector_pop_back;
SwigExternC!(size_t function(void* jarg1)) RegisterPtrVector_size;
SwigExternC!(size_t function(void* jarg1)) RegisterPtrVector_capacity;
SwigExternC!(void function(void* jarg1, size_t jarg2)) RegisterPtrVector_reserve;
SwigExternC!(void* function()) new_RegisterPtrVector__SWIG_0;
SwigExternC!(void* function(void* jarg1)) new_RegisterPtrVector__SWIG_1;
SwigExternC!(void* function(size_t jarg1)) new_RegisterPtrVector__SWIG_2;
SwigExternC!(void* function(void* jarg1)) RegisterPtrVector_remove__SWIG_0;
SwigExternC!(void* function(void* jarg1, size_t jarg2)) RegisterPtrVector_remove__SWIG_1;
SwigExternC!(void function(void* jarg1, size_t jarg2)) RegisterPtrVector_removeBack;
SwigExternC!(void function(void* jarg1, size_t jarg2, size_t jarg3)) RegisterPtrVector_linearRemove;
SwigExternC!(void function(void* jarg1, size_t jarg2, void* jarg3)) RegisterPtrVector_insertAt;
SwigExternC!(void* function(void* jarg1, size_t jarg2)) RegisterPtrVector_getElement;
SwigExternC!(void function(void* jarg1, size_t jarg2, void* jarg3)) RegisterPtrVector_setElement;
SwigExternC!(void function(void* jarg1)) delete_RegisterPtrVector;
